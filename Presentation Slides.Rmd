...
Based on our one-way ANOVA, we reject the null hypothesis and conclude that there was a statistically significant difference in Median Wages between Major Categories $(F(4, 71) = [16.71], p = [0.00000001013])$.
