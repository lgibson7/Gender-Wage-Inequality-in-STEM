...
* Within the STEM `Majors`, median wage ranged from $\$26,000$ for Zoology (Major Category: Biology & Life Sciences) to $\$110,000$ for Petroleum Engineering (Major Category: Engineering). 
