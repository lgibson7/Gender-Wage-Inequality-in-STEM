...
$Median^{-1} = 2.71 \times 10^{-5} -3.441 \times 10^{-6}x_1 - 8.87 \times 10^{-6} x_2 -3.991 \times 10^{-7} x_3 -3.09\times 10^{-6}x_4 -4.14 \times 10^{-11}x_5 +1.08 \times 10^{-6}x_6 +8.97\times 10^{-11} x_5 \times x_6$
...
Looking at the actual `Median` for Statistics & Decision Sciences, we see that the actual response is within our prediction interval of (309997,61595).
```{r echo=FALSE, include=FALSE}
dat1[35,3:9]
```
...
- You can predict the median wage of STEM majors based on the major category, total number of men in the major and total proportion of women in the major.
