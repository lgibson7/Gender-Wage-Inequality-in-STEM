...
\scriptsize$$Y^{-1}= 2.71 \cdot (10)^{-5} - 3.441 \cdot (10)^{-6} x_1 - 8.87 \cdot (10)^{-6} x_2 - 3.991 \cdot (10)^{-7} x_3 - 3.09 \cdot (10)^{-6} x_4 - 4.14 \cdot (10)^{-11} x_5 + 1.08 \cdot (10)^{-6} x_6 + 8.977 \cdot (10)^{-11} x_5 \cdot x_6$$.
