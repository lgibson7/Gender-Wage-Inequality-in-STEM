...
```{r}
library(pacman)
p_load(dplyr, ggplot2, ggpubr, scales, MASS, car, lmtest, ggrepel, faraway)
...
dat1 %>%
  ...
  geom_text(data=outlier_pts, aes(label=Major, size=0.089), 
            nudge_y=2, vjust=-1.6, hjust=0.7) + # label outliers 
...
sufficient evidence that the median saleries are significantly different based
...
the predictor "ShareWomen" as we expect that the standard erorr for this predictor 
